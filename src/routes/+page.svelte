	...
	<div class="flex flex-col justify-center px-8">
		<div class="flex flex-col justify-center max-w-2xl mx-auto mb-4 mt-40">
			...
			<h2 class="text-xl font-medium text-slate-500 mt-2">
				Digital Thread Research Scientist at Idaho National Laboratory
			</h2>
			<div class="prose text-md text-slate-200 mt-8 mb-8">
				...
				<p>
					...
					degree in Physics with a minor in Mathematics. Additionally, I served as an undergraduate
					research assistant with the COHE (Complex Oxides Heterostructures and Electronics) group.
					During that time i developed a probe for testing samples immersed in liquid nitrogen.
				</p>
				<p>
			...
			<footer class="flex flex-col justify-center items-start max-w-2xl mx-auto w-full mb-8 mt-8">
				...
				<div class="flex flex-row-reverse sm:flex-row mb-8 space-x-0 sm:space-x-2 w-full">
					...
					<a href="https://github.com/JakeSwinford"
						><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" class="fill-zinc-700"
							><path
